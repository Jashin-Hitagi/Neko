...
@WebServlet(name = "SelectFilghtServ",urlPatterns = "/selectFilght.do")
public class SelectFilghtServ extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("selectFilght.jsp").forward(request,response);
    }
