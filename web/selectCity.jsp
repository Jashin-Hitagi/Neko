    ...
    <div class="container" style="width: 1400px">
        ...
        <div style="width: 150px;height: 400px;float: left">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="selectFilght.do">航班查询</a></li>
                <li class="active"><a href="selectCity.do">城市名</a></li>
        ...
        <div style="float: left;margin-left: 50px">
            <nav class="navbar navbar-default" role="navigation" style="background-color: white">
                <div class="container-fluid">
                    <form class="navbar-form navbar-left" action="selectCity.do" method="post" id="form1" name="form1">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="出发城市" name="s_place" id="s_place">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="到达城市" name="a_place" id="a_place">
                        </div>
                        <button type="button" class="btn" onclick="submit1()">查询</button>
                    </form>
                </div>
            </nav>
            ...
            <ul class="pagination" style="margin-left: 45%">
                <c:if test="${f_index>1}">
                    <li class="page-item"><a class="page-link" href="selectCity.do?f_index=1">首页</a></li>
                    <li class="page-item"><a class="page-link" href="selectCity.do?f_index=${f_index-1}">&laquo;</a></li>
                </c:if>
                <c:forEach var="num" begin="1" end="${f_total}">
                    <li class="page-item"><a class="page-link" href="selectCity.do?f_index=${num}">${num}</a></li>
                </c:forEach>
                <c:if test="${f_index<f_total}">
                    <li class="page-item"><a class="page-link" href="selectCity.do?f_index=${f_index+1}">&raquo;</a></li>
                    <li class="page-item"><a class="page-link" href="selectCity.do?f_index=${f_total}">末页</a></li>
                </c:if>
            </ul>
        </div>
    </div>
