    ...
    <div class="container" style="width: 1200px">
        ...
        <div style="width: 150px;height: 400px;float: left">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="myOrder.jsp">订单中心</a></li>
                <li  class="active"><a href="change.jsp">改签</a></li>
        ...
        <div style="float: left;margin-left: 50px">
            <nav class="navbar navbar-default" role="navigation" style="background-color: white">
                <div class="container-fluid">
                    <form class="navbar-form navbar-left" action="newChange.do" method="post">
                        ...
                        <div class="form-group">
                            改签航班:  &nbsp;&nbsp;&nbsp; <input type="text" class="form-control" style="width: 180px" placeholder="输入航班号" name="f_id">
                        </div><br><br><br>
