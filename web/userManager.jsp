        ...
        <div style="float: left;margin-left: 50px">
            <table class="table table-hover">
                ...
                <c:forEach items="${list}" var="f">
                    <tr>
                        <td style="vertical-align: middle">${f.u_id}</td>
                        <td style="vertical-align: middle">${f.u_pwd}</td>
                        <td style="vertical-align: middle">${f.u_name}</td>
                        <td style="vertical-align: middle">${f.sex}</td>
                        <td><button type="button" class="btn" id="myButton4" onclick="location.href='deleteUser.do?id=${f.u_id}'">注销用户
                        </button></td>
                    </tr>
                </c:forEach>
                </tbody>
