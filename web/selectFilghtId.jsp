    ...
    <div class="container" style="width: 1400px">
        ...
        <div style="width: 150px;height: 400px;float: left">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="selectFilghtId.do">航班号</a></li>
            </ul>
        </div>
        <div style="float: left;margin-left: 50px">
            <nav class="navbar navbar-default" role="navigation" style="background-color: white">
                <div class="container-fluid">
                    <form class="navbar-form navbar-left" action="selectFilghtId.do" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="航班编号" name="f_id">
                        </div>
